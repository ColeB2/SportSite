...
class LADeleteGameInfoViewTest(TestCase):
    """
    Tests league_admin_delete_game_info_view 
        from league_admin/views/game_views.py
    ...
    def test_view_without_logging_in(self):
        response = self.client.get(
            '/league/admin/schedule/2022/stages/1/1/delete')
        self.assertEqual(response.status_code, 302)
    ...
    def test_view_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response,
            "league_admin/game_templates/game_delete.html")
    ...
    def test_context(self):
        ...
        self.assertEqual(response.context["season_year"],
            int(self.stage.season.year))
