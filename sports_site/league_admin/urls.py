...
urlpatterns = [
    ...
    path('players/<int:player_pk>/edit',
    ...
    path('players/<int:player_pk>/delete',
    ...
    path('schedule/<int:season_year>/stages/<int:season_stage_pk>',
        views.league_admin_schedule_view,
        name='league-admin-schedule'),
    path('schedule/<int:season_year>/stages/<int:season_stage_pk>/create',
        views.league_admin_schedule_create_view,
        name='league-admin-schedule-create'),
    path('schedule/<int:season_year>/stages/<int:season_stage_pk>/delete',
    ...
    path('season/<int:season_year>/<int:season_pk>',
        views.league_admin_season_stage_select_view,
        name='league-admin-season-stage'),
    path('season/<int:season_year>/<int:season_pk>/<int:pk>/edit/season',
        SeasonEditView.as_view(),
        name='league-admin-season-edit'),
    path('season/<int:season_year>/<int:season_pk>/delete',
